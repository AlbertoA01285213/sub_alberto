...
ASMC6DOF::ASMC6DOF(float sample_time, const float* lambda, const float* K2, const float* K_alpha, const float* K1_init, const float* K_min, const float* mu)
...
void ASMC6DOF::setMaxThrust(float* MAX_TAU){
